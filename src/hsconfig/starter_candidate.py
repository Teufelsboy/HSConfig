...
STARTER_CANDIDATE_FINDING_CODES = frozenset({
    ...
    "starter_candidate_combo_fields_invalid",
    ...
    "starter_candidate_mulligan_conflict",
    "starter_candidate_mulligan_duplicate",
    "starter_candidate_mulligan_fields_invalid",
