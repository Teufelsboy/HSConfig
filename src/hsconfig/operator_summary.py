...
(_operator_summary_invoker_primary,) = _freeze_operator_function_graph(
    (_invoke_operator_summary_evaluator,)
)
(_operator_summary_invoker_backup,) = _freeze_operator_function_graph(
    (_invoke_operator_summary_evaluator,)
)
_evaluate_operator_summary_inputs = _guard_operator_callable(
...
(_summary_projection_primary,) = _freeze_operator_function_graph(
    (_invoke_operator_summary_projection,)
)
(_summary_projection_backup,) = _freeze_operator_function_graph(
    (_invoke_operator_summary_projection,)
)
build_operator_summary_from_inputs = _guard_operator_callable(
...
(_legacy_operator_summary_primary,) = _freeze_operator_function_graph(
    (build_operator_summary,)
)
(_legacy_operator_summary_backup,) = _freeze_operator_function_graph(
    (build_operator_summary,)
)
...
(_legacy_invoker_primary,) = _freeze_operator_function_graph(
    (_invoke_legacy_operator_summary,)
)
(_legacy_invoker_backup,) = _freeze_operator_function_graph(
    (_invoke_legacy_operator_summary,)
)
_legacy_operator_summary_source = build_operator_summary
build_operator_summary = _guard_operator_callable(
