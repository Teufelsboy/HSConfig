...
from hsconfig.io import read_json, slugify_deck_name
from hsconfig.internal_source_authority import InternalSourceAuthorityHandoff
...
class LegacyWorkflowDependencies:
    ...
    build_lowered_runtime_stage: Callable[..., Any]
    write_json: Callable[..., Any]
    refresh_package_derivation_authority: Callable[..., dict[str, Any]]
...
def build_package_payload(
    ...
    *,
    ...
    fetch_latest_cards = dependencies.fetch_latest_cards
    _research_required_guide_sources = dependencies.research_required_guide_sources
    build_lowered_runtime_stage = dependencies.build_lowered_runtime_stage
    write_json = dependencies.write_json
