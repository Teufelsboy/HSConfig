...
Current truth index: `docs/research/current-truth.md`. Use it as the only place that names the active evidence packages before opening older historical research folders.
