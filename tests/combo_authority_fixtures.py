...
_CANONICAL_COMBO_CLAIMS = (
    {
        ...
        "operator": ">>",
        "values": ["12", "8"],
        "evidence_text_short": "Play CARD_A then CARD_B in the same turn.",
    ...
    },
    {
        ...
        "evidence_text_short": "Play EX1_001 into EX1_002 under an unknown condition.",
        "source_confidence": "high",
        "promotion_eligible": True,
    },
    {
        ...
        "evidence_text_short": "Play EX1_001 followed by EX1_002 with a wrapped condition.",
        "source_confidence": "high",
        "promotion_eligible": True,
    },
    {
        ...
        "evidence_text_short": "Play EX1_001 -> EX1_002 with a card condition.",
        "source_confidence": "high",
        "promotion_eligible": True,
    },
    {
        ...
        "evidence_text_short": "Play EX1_001 then EX1_002 with a partner condition.",
        "source_confidence": "high",
        "promotion_eligible": True,
    },
    {
        ...
        "evidence_text_short": "Play EX1_001 into EX1_002 with a hand condition.",
        "source_confidence": "high",
        "promotion_eligible": True,
    },
    {
        ...
        "operator": ">>",
        "values": ["12", "8"],
        "evidence_text_short": "Play CARD_A followed by CARD_B.",
        "source_confidence": "high",
        "promotion_eligible": True,
    },
    {
        ...
        "operator": ">>",
        "values": ["10", "10"],
        "evidence_text_short": "Play CARD_A -> CARD_MISSING.",
        "source_confidence": "high",
        "promotion_eligible": True,
    },
    {
        ...
        "operator": ">>",
        "values": ["10", "10"],
        "evidence_text_short": "Play CARD_A then CARD_MISSING.",
        "source_confidence": "high",
        "promotion_eligible": True,
    },
    {
    ...
    },
    {
        ...
        "operator": ">->",
        "values": ["20", "30"],
        "evidence_text_short": "Play CARD_A followed by CARD_B across turns.",
        "source_confidence": "high",
        "promotion_eligible": True,
    },
    {
    ...
    {
        "claim_id": "combo-plus-coexistence",
        "claim_kind": "combo_sequence",
        "cards": ["CARD_A", "CARD_B"],
        "sequence": ["CARD_A", "CARD_B"],
        "timing_kind": "same_turn",
        "operator": ">>",
        "values": ["10", "10"],
        "evidence_text_short": "CARD_A + CARD_B.",
        "source_confidence": "high",
        "promotion_eligible": True,
    },
    {
        "claim_id": "combo-marker-unordered-list",
        "claim_kind": "combo_sequence",
        "cards": ["CARD_A", "CARD_B"],
        "sequence": ["CARD_A", "CARD_B"],
        "timing_kind": "same_turn",
        "operator": ">>",
        "values": ["10", "10"],
        "evidence_text_short": "Combo:\n- CARD_A\n- CARD_B",
        "source_confidence": "high",
        "promotion_eligible": True,
    },
    {
        "claim_id": "combo-undirected-sentence",
        "claim_kind": "combo_sequence",
        "cards": ["CARD_A", "CARD_B"],
        "sequence": ["CARD_A", "CARD_B"],
        "timing_kind": "same_turn",
        "operator": ">>",
        "values": ["10", "10"],
        "evidence_text_short": "Use CARD_A with CARD_B in this deck.",
        "source_confidence": "high",
        "promotion_eligible": True,
    },
    {
        "claim_id": "combo-exact-decklist-coexistence",
        "claim_kind": "combo_sequence",
        "cards": ["CARD_A", "CARD_B"],
        "sequence": ["CARD_A", "CARD_B"],
        "timing_kind": "same_turn",
        "operator": ">>",
        "values": ["10", "10"],
        "evidence_text_short": "Exact deck list: CARD_A, CARD_B.",
        "source_confidence": "high",
        "promotion_eligible": True,
    },
    {
        "claim_id": "combo-prefix-collision",
        "claim_kind": "combo_sequence",
        "cards": ["CARD_A", "CARD_B"],
        "sequence": ["CARD_A", "CARD_B"],
        "timing_kind": "same_turn",
        "operator": ">>",
        "values": ["10", "10"],
        "evidence_text_short": "CARD_AX then CARD_B.",
        "source_confidence": "high",
        "promotion_eligible": True,
    },
    {
        "claim_id": "combo-effect-clause-then",
        "claim_kind": "combo_sequence",
        "cards": ["CARD_A", "CARD_B"],
        "sequence": ["CARD_A", "CARD_B"],
        "timing_kind": "same_turn",
        ...
        "values": ["10", "10"],
        "evidence_text_short": (
            "CARD_A draws one, then discards one; CARD_B remains available."
        ),
        "source_confidence": "high",
        "promotion_eligible": True,
    },
    {
        "claim_id": "combo-effect-clause-into",
        "claim_kind": "combo_sequence",
        "cards": ["CARD_A", "CARD_B"],
        "sequence": ["CARD_A", "CARD_B"],
        "timing_kind": "same_turn",
        ...
        "values": ["10", "10"],
        "evidence_text_short": (
            "CARD_A shuffles junk into your deck while CARD_B remains available."
        ),
        "source_confidence": "high",
        "promotion_eligible": True,
    },
    {
        ...
        "sequence": ["CARD_A", "CARD_B", "CARD_C"],
        "timing_kind": "same_turn",
        "operator": ">>",
        "values": ["10", "10", "10"],
        "evidence_text_short": (
            "CARD_A then CARD_B draws one, then discards one; CARD_C remains available."
        ),
        "source_confidence": "high",
        "promotion_eligible": True,
    },
    {
        ...
        "operator": ">>",
        "values": ["10", "10"],
        "evidence_text_short": "CARD_A and CARD_MISSING are listed together.",
        "source_confidence": "high",
        "promotion_eligible": True,
    },
)
