...
def _verify_twelve_decks_command() -> tuple[str, ...]:
    return (
        sys.executable,
...
def test_twelve_deck_verifier_uses_current_test_interpreter() -> None:
    """Catches reintroduction of a global launcher or version-pinned runtime."""
    assert _verify_twelve_decks_command()[0] == sys.executable
